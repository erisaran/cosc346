 ...
 */
    ...
    */
    ...
    /**
     makes a deep copy of the vector with the same values  uses some maths to get the compiler to assign the value to a new T object rather than just referencing the T from the old array
